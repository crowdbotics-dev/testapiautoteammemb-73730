...
## Project Structure
    ...
    ├── testapiautoteammemb_73730  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_73730`
...
2. Clone this repo and `cd testapiautoteammemb_73730`
